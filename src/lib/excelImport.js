...
export async function parseStudentsExcel(file) {
  ...
  rows.forEach((row, i) => {
    ...
    students.push({
      ...
      feePercent: (() => { const v = pick(row, "% học phí", "% Học phí", "Phan tram hoc phi"); const n = parseFloat(v); return isNaN(n) ? 100 : n; })(),
...
export function downloadStudentTemplate() {
  downloadTemplate(
    [{ "Họ tên": "Nguyễn Văn A", "Khối": "10", "SĐT": "0900000000", "Phụ huynh": "Nguyễn Văn B", "SĐT PH": "0911111111", "CCCD PH": "", "MST PH": "", "% học phí": 100, "Địa chỉ": "12 Lê Lợi, Q1", "Ngày nhập học": "01/07/2026", "Lớp học": "Toán 10A, Anh 9A" }],
    "Học sinh", "Mau-danh-sach-hoc-sinh.xlsx", [20, 8, 14, 20, 14, 16, 12, 12, 28, 14, 22]
  );
}
